...
$url = "https://raw.githubusercontent.com/DavidWuibaille/Tanium/main/Provision/Customer-ext.ps1"

# Définir le chemin local pour sauvegarder le fichier
$localPath = "C:\Windows\Temp\Customer-ext.ps1"
